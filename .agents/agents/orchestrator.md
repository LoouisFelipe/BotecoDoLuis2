...
skills: 
  ...
  - firebase-basics
  - firebase-firestore (para manipulação atômica)
  - firebase-security-rules-auditor (para validar o bypass do CEO)
---

# 🤖 Orchestrator (BotecoDoLuis2)
...
2. **Regra de Expediente:** O boteco funciona de madrugada. Fechamentos entre 00:00 e 05:59 pertencem ao "Expediente" do dia anterior (use `dataExpediente`). Exigir que o database-architect use uma função centralizada de getDataExpediente() em vez de cálculos manuais nos componentes.
